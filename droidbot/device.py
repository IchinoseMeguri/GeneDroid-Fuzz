...
class Device(object):
    ...
    def connect(self):
        ...
        self.get_sdk_version()              # 获取sdk版本
        self.get_release_version()          # 获取发布版本
        self.get_ro_secure()                # 获取ro_secure
        self.get_ro_debuggable()            # 获取ro_debuggable
        self.get_display_info()             # 获取显示信息

        self.unlock()                       # 解锁
        self.check_connectivity()           # 检查连接性
    ...
    def is_foreground(self, app):# 是否在前台
        """
    ...
    def get_model_number(self):# 获取型号
        """
        Get model number
        """
    ...
    def add_contact(self, contact_data):
        ...
        self.send_intent(intent=contact_intent)# 发送意图
        time.sleep(2)
        self.adb.press("BACK")
        time.sleep(2)
        self.adb.press("BACK")
    ...
    def receive_call(self, phone=DEFAULT_NUM):# 接收电话
        """
